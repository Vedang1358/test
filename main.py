...
data=Database(db='mydatabase.db')
...
Label(f1,text="Current Date",font=f).grid(row=2,column=0,sticky=W)
...
submit_btn=Button(f1,text='Save Record',font=f,bg='#42602D',fg='white',command=saveRecord,width=15)
clr_btn=Button(f1,text='Clear Entry',font=f,bg='#D9B036',fg='white',command=clearEntries,width=15)
quit_btn=Button(f1,text='Quit',font=f,bg='#D33532',fg='white',command=lambda:ws.destroy(),width=15)
total_bal=Button(f1,text='Total Balance',font=f,bg='#486966',fg='white',command=totalBalance,width=15)
#total_spent=Button(f1,text='Total Balance',font=f,bg='#486966',command=lambda :data.fetchRecord('select sum(ite)'))
update_btn=Button(f1,text='Update',bg='#C2BB00',command=update_record,font=f)
